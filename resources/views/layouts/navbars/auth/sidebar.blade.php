    ...
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          ...
          <p class="text-xs font-weight-bold">Please check our FAQ's</p>
          <a href="/documentation/getting-started/overview.html" target="_blank" class="btn btn-white btn-sm w-100 mb-0">FAQ's</a>
        </div>
      </div>
    </div>
  </div>
